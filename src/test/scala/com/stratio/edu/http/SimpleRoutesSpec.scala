...
import com.stratio.edu.http.routes.SimpleRoutes
...
/**
  ...
  * }
  */
class SimpleRoutesSpec extends WordSpec with Matchers with ScalaFutures with ScalatestRouteTest with JsonSupport {
